...
class yamld:
    ...
    def __init__(self,modulename):
        ...
        self.S2CCLK_1=self.getdata()[self.modulename]["S2CCLK_1"]
        self.S2CCLK_2=self.getdata()[self.modulename]["S2CCLK_2"]
        self.S2CCLK_3=self.getdata()[self.modulename]["S2CCLK_3"]
        self.S2CCLK_4=self.getdata()[self.modulename]["S2CCLK_4"]
        self.S2CCLK_5=self.getdata()[self.modulename]["S2CCLK_5"]
        self.S2CCLK_6=self.getdata()[self.modulename]["S2CCLK_6"]
        self.S2CCLK_7=self.getdata()[self.modulename]["S2CCLK_7"]
        self.S2CCLK_8=self.getdata()[self.modulename]["S2CCLK_8"]
        self.fpga1_bitfile=self.getdata()[self.modulename]["fpga1_bitfile"]
        self.fpga2_bitfile=self.getdata()[self.modulename]["fpga2_bitfile"]
